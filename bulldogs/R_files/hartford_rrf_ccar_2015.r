...
base_formula <- c('DJ1YR','CPI','TSLOPE')
large_co_facs <- c('CPIASIA','CPIEUR','CPIJPN','CPIUK','FXASIA','FXEUR','FXJPN','FXUK','RGDPASIA','RGDPEUR','RGDPJPN','RGDPUK')
base_plus <- list(c('RGDP','NGDP'),c('TREAS3MO','TREAS5YR','TREAS10Y'), c('TR3M_1YD','TR5Y_1YD','TR10Y_1YD'))
...
tahitiWriteTable(gcset,'therocrates.hartford_spreads_rrf3_1')
}
