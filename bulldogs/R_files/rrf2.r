...
query <- paste("select distinct gvkey from rrf2.dbo.kdp_jc5 order by gvkey")
gvkeys <- fq(query)[[1]]

MacroFactors <- getMacroFactorsRRF2(rset=2)
names(MacroFactors) <- 'base_40'
mfacs <- MacroFactors[[1]]
