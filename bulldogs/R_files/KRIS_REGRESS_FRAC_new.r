...
if(algo_id == 1)	attempt_gvkey <- try(source("D:/KRIS_R/run_sw_asc_frac_new.r"))
if(algo_id == 2)	attempt_gvkey <- try(source("D:/KRIS_R/run_sw_desc_frac_new.r"))
if(algo_id == 3)	attempt_gvkey <- try(source("D:/KRIS_R/reg_all_frac_new.r"))
