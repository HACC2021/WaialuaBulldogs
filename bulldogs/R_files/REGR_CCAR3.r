...
runthese <<- function(trythese,wf) {
	...
	base_formula <- c('QVIXM','QCREIDX_R1Y_NON','QHOUSEIDX_R1Y_NON','QDJIDX_R1Y_NON','QCPI','QBBBSPD','QTSLOPE','QUNEMP')
	large_co_facs <- c('QCPIASIA','QCPIEUR','QCPIJPN','QCPIUK','QFXASIA','QFXEUR','QFXJPN','QFXUK','QRGDPASIA','QRGDPEUR','QRGDPJPN','QRGDPUK')
	base_plus <- list(c('QRGDP','QNGDP'), c('QUNEMP_D1Y_NON','QUNEMP_D6M_NON','QUNEMP_D2Y_NON'),c('QPRIME','QTREAS3MO','QTREAS5YR','QTREAS10Y','QMORT'),
							c('QPRIME_D1Y_NON','QTREAS3MO_D1Y_NON','QTREAS5YR_D1Y_NON','QTREAS10Y_D1Y_NON','QMORT_D1Y_NON'), c('QRDISINC','QNDISINC'))
